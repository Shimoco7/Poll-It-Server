 ...
 *        pollQuestionType:
 *          type: enum
 *          enum: [Multi Choice, Image Answers, Image Question, Scorll Down]
...
const pollQuestionSchema = new mongoose.Schema({
    ...
    pollQuestionType: {
        ...
        enum: {values:["Multi Choice", "Image Answers", "Image Question", "Scorll Down"], message: "Please enter a valid poll question type"},
        default: "Multi Choice"
    },
    choices: {
        type: [String]
